...
def create_booking_checkout_session(booking):
    ...
    if Payment.objects.filter(
        ...
        raise serializers.ValidationError("Payment for this booking already exists.")
...
def create_lounge_checkout_session(lounge_access):
    ...
    if Payment.objects.filter(
        ...
        raise serializers.ValidationError("Payment for this lounge access already exists.")
